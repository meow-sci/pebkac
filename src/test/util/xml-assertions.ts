...
// import { calculateMassKgFromGm } from '../../ts/transform/transformSystemEntryToKsaXml';
// import { type GeneratorContext } from '../../ts/data/GeneratorContext';


// export function assertXmlMatchesEntry(context: GeneratorContext, entry: SystemEntry, el: Element) {
...
//     const massStr = calculateMassKgFromGm(gmStr, context);
